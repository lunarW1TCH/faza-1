const BarItem = (props: BarItemProps) => {
  ...
  return (
    <div class='group h-[600px]  px-[3px]  flex flex-col justify-end items-center'>
      <div
        class='barBg w-[20px] sm-down:w-[10px] bg-fg-default z-10 rounded-t-sm relative justify-center flex  mb-[200px] duration-300 group-hover:bg-[#8D8D8D] group-hover:w-[80px] group-hover:sm-down:w-[60px] group-active:bg-[#8D8D8D] group-active:w-[100px] group-active:sm-down:w-[60px]'
